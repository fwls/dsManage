<template>
  <div class="main">
    <div class="login-box">
      <form  class="form_main" onsubmit="return false;">
        ...
        <div class="inputContainer">
          ...
          <input type="text" class="inputField" id="username" v-model="model.username" placeholder="Username">
        </div>
        ...
        <div class="inputContainer">
          ...
          <input type="password" class="inputField" v-model="model.password" id="password" placeholder="Password">
        </div>

        <button id="button" @click="handleLogin">Submit</button>
